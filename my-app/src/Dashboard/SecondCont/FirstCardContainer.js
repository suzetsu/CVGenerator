...
const FirstCardContainer = () => {
    ...
    const company = useSelector((state) => state.selectedCompany.chosenCompany)
    

    const department = company && company.departments.$values;
    ...
    const matchedEmployees = empDetails && empDetails.filter((ex) => 
      
       ex.companyName == compName)
    

//  const allCompanyData = localStorage.getItem("companyInfo") &&   JSON.parse(localStorage.getItem("companyInfo")).option;
 

    // Filter employees based on companyName
    
// console.log(matchedEmployees.filter(Boolean));
    const totalNumberOfEmployees = matchedEmployees && matchedEmployees.length;
                    ...
                    <div className='card1'>
                        <div className='flex'>
                            ...
                            <div className='inside-text pl-4 pt-16 text-white font-helvetica'>
                                ...
                                <div className='text-xl font-bold mb-2'>{totalNumberOfEmployees}</div>
                    ...
                    <div className='card2'>
                        <div className='flex'>
                            ...
                            <div className='inside-text pl-4 pt-16 text-white '>
                                ...
                                <div className='text-xl font-bold mb-2 font-helvetica'>{compName}</div>
