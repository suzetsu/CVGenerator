...
const CVFormat = () => {
  ...
  let DOB = clientDOB && new NepaliDate(new Date(clientDOB));
  const dateOfBirth = DOB && DOB.format(" DD MMMM YYYY");
  ...
  return (
    <div className="flex justify-center bg-[#d9ebeb] pb-4">
      <div className="pt-24">
        <div
          className=" font-helvetica shadow-paper rounded-lg bg-[#FFF] download-pdf"
            ...
            <div className="flex flex-col gap-1 ">
              <div className="h-[10rem] flex justify-between text-black ">
                <div className="float-left w-[100px] h-[100px] bg-cover ">
                  <div
                    style={{
                      backgroundImage: `url(data:image/jpg;base64,${compLogo})`,
                    }}
                    className="w-[100%] h-[100%] bg-cover rounded-[50%]"
                  ></div>
                </div>
                <div className=" flex flex-col gap-2 items-center">
                  <p className="p-0 m-0 text-2xl font-bold pt-4">
                    {" "}
                    CABLECAR EMPLOYEE TRADE UNION
                  </p>

                  <p className="p-0 m-0 flex justify-center">
                    {" "}
                    ICHHAKAMANA-4, CHERES, CHITWAN
                  </p>
                  <div className="text-white mt-2">
                    <p className="bg-black rounded-3xl text-xl font-bold py-2 px-10 flex justify-center">
                      MEMBERSHIP FORM
                    </p>
                  </div>
                </div>
              ...
              <div className="flex justify-between h-[100%] font-helvetica">
                <div className="flex flex-1 pl-[30px] pt-4 flex-col gap-12">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p>
                      {province && (
                        <span className="m-0 p-0">{province} Pradesh,</span>
                      )}{" "}
                      {district && (
                        <span className="m-0 p-0"> {district} District </span>
                      )}
                    </p>
                    <p>
                      <span className="m-0 p-0">{municipality}</span>{" "}
                      {municipalityNumber && (
                        <span className="m-0 p-0">
                          ,Ward No.: {municipalityNumber}
                        </span>
                      )}
                    </p>
                    <p>
                      <span className="m-0 p-0">{tole}</span>
                    </p>
                  </div>
                ...
                <div className="flex flex-1 p-[10px] ml-4 pt-4 flex-col gap-12">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p>
                      ...
                      {skillObject && skillObject.license}
                    </p>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p>
                      Spouse Name:{" "}
                      {familyContactInfoObject &&
                        familyContactInfoObject.spouseName}
                    </p>
                    <p>
                      Mobile No.:{" "}
                      {familyContactInfoObject &&
                        familyContactInfoObject.spouseNumber}
                    </p>
                    <p>
                      No. Of Children: Son -{" "}
                      {familyContactInfoObject &&
                        familyContactInfoObject.sonNum}{" "}
                      Daughter -{" "}
                      {familyContactInfoObject &&
                        familyContactInfoObject.daughterNum}
                    </p>
                  </div>
                  <div className="flex flex-col gap-3">
                    ...
                    <p>
                      ...
                      {otherInformationObject &&
                        otherInformationObject.citizenNum}
                      ,{" "}
                      {otherInformationObject &&
                        otherInformationObject.issueDistrict}
                      ,{" "}
                      {otherInformationObject &&
                        otherInformationObject.issueDate}
                    </p>
                    <p>
                      PF/SSF No.:{" "}
                      {otherInformationObject &&
                        otherInformationObject.pfSsfNum}
                    </p>
                    <p>
                      CIT No.:{" "}
                      {otherInformationObject && otherInformationObject.citNum}
                    </p>
                    <p>PAN No.: {clientPANNO}</p>
                    <p>
                      Insurance No.:{" "}
                      {otherInformationObject &&
                        otherInformationObject.insuranceNum}
                    </p>
                    <p>
                      Insurance Company:{" "}
                      {otherInformationObject &&
                        otherInformationObject.insuranceCompany}
                    </p>
                  </div>
                </div>
              </div>
